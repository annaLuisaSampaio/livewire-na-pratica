    ...
    <form action="" wire:submit.prevent="updateExpense" class="w-full mx-auto max-w-7xl">
        ...
        <div class="flex flex-wrap mb-6 -mx-3">
            ...
            <p class="w-full px-3 mb-6 md:mb-0">
                ...
                <img src="{{route('expenses.photo', $expense->id)}}" alt="" width="150px" class="my-4">
        ...
        <div class="w-full px-3 py-4 mb-6 md:mb-0">
            ...
            <button type="submit"
                    class="flex-shrink-0 px-2 py-1 text-sm text-white bg-teal-500 border-4 border-teal-500 rounded hover:bg-teal-700 hover:border-teal-700">Atualizar Registro</button>
        </div>
    </form>
</div>